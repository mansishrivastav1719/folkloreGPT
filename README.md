...
flowchart TD
    ...
    subgraph Future_Round2_Logic["🔮 Round 2 AI Integration"]
        D -- "3. Query Data for Training" --> E
        D -- "4. Generate New Story" --> A
    end
...
👥 Team
[Team Member 1: Mansi Shrivastav] - Backend development & database design
[Team Member 2: Pankaj Singh] - Full-stack development & system architecture
[Team Member 3: Priyanka Sharma] - Frontend development & UI/UX
[Team Member 4: MD Arif] - Project coordination & documentation